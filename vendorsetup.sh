...
wget https://raw.githubusercontent.com/oliveiraleo/Patch-Kuntao/lineage-19.1/framework_base/0025-Update-Spoof-fingerprint-patch.patch
...
patch -p1 <0025-Update-Spoof-fingerprint-patch.patch
cd ../..
